...
// muestra en consola el número en la página	
...
//determina si no hay números repetidos y devuelve true si se cumple esta condición
...
randownumber1 = ("" + randownumber).split(""); 
	
//parte el número del input de cuatro cifras y guarda cada dígito como un elemento en un  arreglo
value1 = value.split("");
